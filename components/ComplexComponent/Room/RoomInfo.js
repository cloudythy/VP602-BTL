      ...
      <View style={styles.normal.info}>
        ...
        <View style={styles.wrapper}>
          <Text style={{ color: COLOR.common.darkGrey }}>
            <Text style={styles.normal.price}>{price}</Text> VND/month
          </Text>
          <Text style={styles.normal.address}>(+) {address}</Text>
        </View>
        <View style={styles.wrapper}>
          <Text style={styles.normal.text}>
            (+) {numOfRooms} {numOfRooms > 1 ? "bedrooms" : "bedroom"}
          </Text>
          <Text style={styles.normal.text}>
            (+) {numOfPeople} {numOfPeople > 1 ? "persons" : "person"}
          </Text>
          <Text style={styles.normal.text}>(+) Deposit: {deposit} VND</Text>
        </View>
      ...
      <View style={styles.small.info}>
        <View style={styles.wrapper}>
          ...
          <Text style={styles.small.text}>
            <Text style={{ color: COLOR.user.primaryShade[200] }}>{price}</Text>{" "}
            VND/month
          </Text>
        </View>
        <View style={styles.wrapper}>
